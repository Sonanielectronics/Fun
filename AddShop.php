    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Master Account</span><i
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Fund Transfer</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-menu-button-wide"></i><span>Bet Amounts</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3">
                                <div class="col-md-4">
                                    <label for="validationDefault01" class="form-label">Shop Name :</label>
                                    <input type="text" class="form-control" id="validationDefault01"
                                        placeholder="Shop Name" required>
                                </div>
                                <div class="col-md-4">
                                    <label for="validationDefault02" class="form-label">Owner Name :</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <button class="btn btn-primary" type="submit"
                                        style="margin-top: 10px;margin-bottom: 10px;">Generate</button>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <label for="validationDefault01" class="form-label">Master Id :</label>
                                    <select id="inputState" class="form-select">
                                        <option selected="">Select Mastre ID</option>
                                        <option>...</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
