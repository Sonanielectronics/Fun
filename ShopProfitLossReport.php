        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Shop Profit/Loss Report</h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td scope="col">Sasane N3 <br> 00665491</td>
                                        <td scope="col">31-<br>07-<br>2023</td>
                                        <td scope="col">3610</td>
                                        <td scope="col">3600</td>
                                        <td scope="col">2090</td>
                                        <td scope="col">3400</td>
                                        <td scope="col">2030</td>
                                        <td scope="col">2630</td>
                                        <td scope="col">3150</td>
                                        <td scope="col">1680</td>
                                        <td scope="col">2280</td>
                                        <td scope="col">2000</td>
                                        <td scope="col">26470</td>
