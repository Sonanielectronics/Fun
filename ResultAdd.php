                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-2">
                                    <label for="inputCity" class="form-label">High % :</label>
                                ...
                                <div class="col-md-2">
                                    <label for="inputCity" class="form-label">Low % :</label>
                                    <select id="inputState" class="form-select">
                                        <option selected="">Select Percentage</option>
                                        <option>...</option>
                                    </select>
                                ...
                                <div class="col-md-2">
                                    <label for="inputCity" class="form-label">Profit Limit % :</label>
                                    <select id="inputState" class="form-select">
                                        <option selected="">Select Percentage</option>
                                        <option>...</option>
                                    </select>
                                ...
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Shop Profit :</label>
                                    <input class="form-control" id="inputZip">
                                </div>
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label" style="visibility: hidden;">Amount
                                        :</label>
                                    <div class="row mb-3">
                                        <div class="col-sm-10">
                            ...
                            <table class="table datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Foure</th>
                                        <th scope="col">Five</th>
                                        <th scope="col">Six</th>
                                        <th scope="col">Saven</th>
