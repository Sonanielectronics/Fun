                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3">
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Bets Name :</label>
                                    <input placeholder="Name" class="form-control" id="inputZip">
                                </div>
                                <div class="col-md-2">
                                    <label for="inputState" class="form-label">Amount :</label>
                                    <input placeholder="Amount" class="form-control" id="inputZip">
                                </div>
                                <div class="col-md-6">
