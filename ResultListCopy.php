        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Results List</h5>
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">1</th>
                                        <td scope="col">2023-05-02</td>
                                        <td scope="col">10%</td>
                                        <td scope="col">90 %</td>
                                        <td scope="col">15</td>
                                        <td scope="col">2023-05-02 07:22:47</td>
                                        <td style="text-align: center;" scope="col">
                                            <button><i class="fas fa-pen"></i></button>
                                            <button style="margin-top: 1px;"><i class="fas fa-trash"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
